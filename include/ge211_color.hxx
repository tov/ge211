...
public:
    ...
    struct HSVA
    {
        ...
        /// Produces a brighter color by increasing the saturation. The
        /// `unit_amount` must be between 0 and 1, where 0 leaves the
        /// color the same, and 1 produces a fully bright color.
