...
bool map_button(uint8_t input, Mouse_button& output) NOEXCEPT_
{
    switch (input) {
...
static Key map_key(const SDL_KeyboardEvent& e) NOEXCEPT_
{
...
Key::Key(const SDL_KeyboardEvent& e) NOEXCEPT_
        : Key{map_key(e)}
{ }

static const char* mouse_button_name(Mouse_button button) NOEXCEPT_
{
    switch (button) {
...
static const char* key_type_name(Key::Type type) NOEXCEPT_
{
    switch (type) {
        case Key::Type::code:
            return "ascii";
...
bool Key::is_textual() const NOEXCEPT_
{
